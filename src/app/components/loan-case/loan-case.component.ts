...
@Component({
  selector: 'app-loan-case',
  templateUrl: './loan-case.component.html',
  styleUrls: ['./loan-case.component.scss']
})
export class LoanCaseComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.caseService.startCase("loanCase");
  }
