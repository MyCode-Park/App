          ...
          (form: FlowForm | null) =>{
            ...
            this.props = {
              ...
              onOutcomePressed: (payload: Model.Payload, result: any, navigationUrl?: string, outcomeConfig?: Model.ResolvedColumn) => {
                ...
                // this.taskFormService.submitCase(this.taskId,payload,result,outcomeConfig?.value)
                this.taskFormService.completeTask(this.taskId,payload,result,outcomeConfig?.value)
